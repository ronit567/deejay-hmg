...
${formData.details}
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section id="home" className="relative h-[90vh] bg-black overflow-hidden">
        <div className="">
        </div>
      ...
      <video className="w-full h-full object-cover" autoPlay loop muted>
        ...
        Your browser does not support the video tag.
          ...
          <div className="absolute inset-0">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-amber-700/20 via-transparent to-transparent glow-effect"></div>
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col">
          ...
          <div className="pt-4 md:pt-8 flex justify-end items-center">
            <div className="hidden md:flex items-center space-x-6 text-sm tracking-widest uppercase font-montserrat">
              <button onClick={() => scrollToSection('home')} className="hover:text-amber-700 transition-colors font-bold">Home</button>
              <span className="text-amber-700/50 mx-1">/</span>
              <button onClick={() => scrollToSection('biography')} className="hover:text-amber-700 transition-colors font-bold">Biography</button>
              <span className="text-amber-700/50 mx-1">/</span>
              <button onClick={() => scrollToSection('booking')} className="hover:text-amber-700 transition-colors font-bold">Book Now</button>
            </div>
          </div>
          ...
          <div className="flex-1 flex items-center justify-center -mt-12">
            <div className="text-center space-y-6">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-7xl font-syncopate font-black tracking-wider text-white">
                  DEEJAY HMG
                </h1>
                <div className="text-lg md:text-xl max-w-2xl mx-auto font-bold text-gray-300">
                  <p className="typing-effect-1">Let us help you create unforgettable memories.</p>
                  <p className="typing-effect-2">Bookings for Ontario Are Open</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Enhanced Footer with Professional Fonts */}
